// ============================================================================
// VENDORED VERBATIM — reference only, do NOT edit.
// "Raytraced Ocean" — SDF raymarched water (Fresnel reflect/refract, Beer-Lambert
// volume march, Voronoi white-water + caustics, raymarched clouds, coral SDF spheres).
//
//   Author:  Chris Wallis  (@chriskwallis)
//   Source:  https://www.shadertoy.com/view/wlsyzH
//   License: Shadertoy's default is CC BY-NC-SA 3.0 unless the author states
//            otherwise. The NC (non-commercial) clause matters — VERIFY the
//            license before shipping this in anything commercial.
//   Captured: 2026-08-03, as a rendering reference for scene 17 (shorewaves).
//
// This is Shadertoy GLSL (uses iChannel0/1, iMouse, iTime, iTimeDelta, iFrame,
// iResolution and two buffers) — it is NOT a drop-in Godot shader. See
// docs/17_shorewaves_mods.md → "R1" for the port/integration plan (the key move
// is replacing QueryOceanDistanceField's analytic sin+fbm surface with our KP07
// sim: sample tx_state.r for the surface height and tx_bottom.r for the floor).
// ============================================================================
